...
export function addStage(
  ...
  return new Map(map).set(key, generate(key, status, isOnePackage));
}

function generate(key: PublishingStage, status: PublishingStageStatus, isOnePackage: boolean): PublishingStageInfo {
  switch (key) {
