  ...
  nuget: {
    solutions: {
      ...
      smp: {
        ...
        slnFileName: 'SMP.sln',
        packages: {
          isozAzureDevops: { projectNames: ['ISOZ.AzureDevops'] },
          isozDataNode: { projectNames: ['ISOZ.DataNode'] },
          isozDynamics365: { projectNames: ['ISOZ.Dynamics365'] },
          isozFranConnect: { projectNames: ['ISOZ.FranConnect'] },
          isozMagento: { projectNames: ['ISOZ.Magento'] },
          isozOdoo: { projectNames: ['ISOZ.Odoo'] },
          isozSapB1: { projectNames: ['ISOZ.SapB1'] },
          isozServiceMinder: { projectNames: ['ISOZ.ServiceMinder'] },
          isozShopify: { projectNames: ['ISOZ.Shopify'] },
          isozWooCommerce: { projectNames: ['ISOZ.WooCommerce'] },
