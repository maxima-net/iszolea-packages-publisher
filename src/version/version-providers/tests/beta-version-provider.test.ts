...
it('returns target version and new version', () => {
  const testCases: TestCase[] = [
    { 
      current: '11.22.3',
      expectedTarget: { version: { major: 11, minor: 22, patch: 3, betaIndex: undefined }, description: TargetVersionDescription.LOCAL_VERSION },
      expectedNew: '11.22.4-beta.1' 
    },
    { 
      current: '11.22.4-beta.1',
      expectedTarget: { version: { major: 11, minor: 22, patch: 4, betaIndex: 1 }, description: TargetVersionDescription.LOCAL_VERSION },
      expectedNew: '11.22.4-beta.2'
    },
    { 
      current: '11.22.4-beta.13',
      expectedTarget: { version: { major: 11, minor: 22, patch: 4, betaIndex: 13 }, description: TargetVersionDescription.LOCAL_VERSION },
...
it('returns target version and new version for current beta with published version info', () => {
  ...
  const testCases: TestCase[] = [
    { 
      ...
      expectedTarget: { version: { major: 11, minor: 22, patch: 3, betaIndex: 1 }, description: TargetVersionDescription.LOCAL_VERSION },
    ...
    { 
      ...
      expectedTarget: { version: { major: 11, minor: 22, patch: 7, betaIndex: 2 }, description: TargetVersionDescription.LATEST_PUBLISHED_BETA_VERSION }, 
      expectedNew: '11.22.7-beta.3' 
    },
    { 
      current: '11.22.7-beta.2',
      expectedTarget: { version: { major: 11, minor: 22, patch: 7, betaIndex: 2 }, description: TargetVersionDescription.LOCAL_VERSION }, 
      expectedNew: '11.22.7-beta.3' 
    },
    { 
      current: '11.22.7-beta.3',
      expectedTarget: { version: { major: 11, minor: 22, patch: 7, betaIndex: 3 }, description: TargetVersionDescription.LOCAL_VERSION }, 
      expectedNew: '11.22.7-beta.4' 
    },
    { 
      current: '11.22.8-beta.1', 
      expectedTarget: { version: { major: 11, minor: 22, patch: 8, betaIndex: 1 }, description: TargetVersionDescription.LOCAL_VERSION }, 
...
it('returns target version and new version for new beta with published version info', () => {
  ...
  const testCases: TestCase[] = [
    {
      current: '11.22.4',
      expectedTarget: { version: { major: 11, minor: 22, patch: 6, betaIndex: 2 }, description: TargetVersionDescription.LATEST_PUBLISHED_BETA_VERSION },
