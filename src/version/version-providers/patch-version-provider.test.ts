...
it('returns target version and new version for current beta with published version info', () => {
  ...
  const testCases: TestCase[] = [
    { 
      ...
      expectedTarget: { version: { major: 11, minor: 22, patch: 3, suffix: 'beta.4' }, description: TargetVersionDescription.LOCAL_VERSION },
      expectedNew: '11.22.3' 
    },
    {
    ...
    { 
      ...
      expectedTarget: { version: { major: 11, minor: 22, patch: 9, suffix: 'beta.3' }, description: TargetVersionDescription.LOCAL_VERSION },
      expectedNew: '11.22.9' 
    },
  ];
